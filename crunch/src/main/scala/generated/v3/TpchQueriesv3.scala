...
class TpchQueries extends Configured with Tool with Serializable {
  ...
  def run(args: Array[String]): Int = {
    ...
    val x3245 = x9.parallelDo(new DoFn[java.lang.String, CPair[java.lang.Integer, LineItem]] {
            ...
            val x3239 = if (x3006) {
              ...
              val x3201 = if (x3190) {
                ...
                val x3197 = if (x3191) {
                  ...
                  x869.__bitset = 65535
                  val x3192 = CPair.of(x841.asInstanceOf[java.lang.Integer], x869);
    ...
    // x46
    val x2793 = x46.parallelDo(new DoFn[java.lang.String, CPair[java.lang.Integer, Order]] {
      def process(input: java.lang.String, emitter: Emitter[CPair[java.lang.Integer, Order]]): Unit = {
        ...
        x441.__bitset = 511
        val x2701 = CPair.of(x427.asInstanceOf[java.lang.Integer], x441);
        emitter.emit(x2701) // yield
        val x2702 = ()
      }

    }, Writables.tableOf(Writables.ints(), Writables.records(classOf[Order])))
    val x3246 = joinNotNull(x3245, x2793);
    // x3246
    val x3263 = x3246.parallelDo(new DoFn[CPair[java.lang.Integer, CPair[LineItem, Order]], CPair[java.lang.String, CPair[java.lang.Integer, java.lang.Integer]]] {
      def process(input: CPair[java.lang.Integer, CPair[LineItem, Order]], emitter: Emitter[CPair[java.lang.String, CPair[java.lang.Integer, java.lang.Integer]]]): Unit = {
        ...
        val x3249 = x3248.second();
        val x3250 = x3249.second();
        ...
        val x3256 = 1 - x3255;
        val x3257 = CPair.of(x3255.asInstanceOf[java.lang.Integer], x3256.asInstanceOf[java.lang.Integer]);
        val x3258 = x3249.first();
        val x3259 = x3258.l_shipmode;
        val x3260 = CPair.of(x3259, x3257);
    ...
    @inline
    def x2669(x125: CPair[java.lang.Integer, java.lang.Integer], x126: CPair[java.lang.Integer, java.lang.Integer]) = {
      val x127 = x125.first();
      val x129 = x126.first();
      val x131 = x127 + x129;
    ...
    val x3265 = x3264.combineValues(new CombineWrapper(x2669));
    // x3265
    val x3279 = x3265.parallelDo(new DoFn[CPair[java.lang.String, CPair[java.lang.Integer, java.lang.Integer]], java.lang.String] {
      def process(input: CPair[java.lang.String, CPair[java.lang.Integer, java.lang.Integer]], emitter: Emitter[java.lang.String]): Unit = {
        ...
        val x3268 = x3267.second();
        val x3269 = x3268.second();
        val x3270 = x3267.first();
        val x3271 = """shipmode """ + x3270;
        val x3272 = x3271 + """: high """;
        val x3273 = x3268.first();
    ...
    val x3280 = pipeline.writeTextFile(x3279, x3);
